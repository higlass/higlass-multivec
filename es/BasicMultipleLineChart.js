...
var BasicMultipleLineChart = function BasicMultipleLineChart(HGC) {
  ...
  var BasicMultipleLineChart = function (_mix$with) {
    _inherits(BasicMultipleLineChart, _mix$with);

    function BasicMultipleLineChart(context, options) {
      _classCallCheck(this, BasicMultipleLineChart);

      var _this = _possibleConstructorReturn(this, (BasicMultipleLineChart.__proto__ || Object.getPrototypeOf(BasicMultipleLineChart)).call(this, context, options));
    ...
    _createClass(BasicMultipleLineChart, [{
      key: 'renderTile',
      ...
      value: function setDimensions(newDimensions) {
        ...
        _get(BasicMultipleLineChart.prototype.__proto__ || Object.getPrototypeOf(BasicMultipleLineChart.prototype), 'setDimensions', this).call(this, newDimensions);
      ...
      key: 'addSVGInfo',
      value: function addSVGInfo(tile, x, y, color) {
        if (tile.svgData && tile.svgData.hasOwnProperty('lineXValues') && tile.svgData.hasOwnProperty('lineYValues') && tile.svgData.hasOwnProperty('lineColor')) {
      ...
      value: function exportSVG() {
        var base = document.createElement('g');
        var track = base;

        var _get$call = _get(BasicMultipleLineChart.prototype.__proto__ || Object.getPrototypeOf(BasicMultipleLineChart.prototype), 'superSVG', this).call(this);
        ...
        var tiles = this.visibleAndFetchedTiles();
        for (var i = 0; i < tiles.length; i++) {
          // unique tiles
          for (var j = 0; j < tiles[i].svgData.lineXValues.length; j++) {
            // unique lines
            var g = document.createElement('path');
            g.setAttribute('fill', 'transparent');
            g.setAttribute('stroke', tiles[i].svgData.lineColor[j]);
            var d = 'M' + tiles[i].svgData.lineXValues[j][0] + ' ' + tiles[i].svgData.lineYValues[j][0];
            for (var k = 0; k < tiles[i].svgData.lineXValues[j].length; k++) {
